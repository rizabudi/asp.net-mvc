var Period = /** @class */ (function () {
    function Period() {
        ...
        this.urlEdit = '/period/edit';
        this.urlSearch = '/period/search';
        this.currentPage = 1;
        this.init();
    }
    Period.prototype.init = function () {
        var _this = this;
        try {
    ...
    Period.prototype.initTable = function (page) {
        try {
    ...
    Period.prototype.initForm = function () {
        var _this = this;
        try {
    ...
    Period.prototype.save = function () {
        var _this = this;
        try {
            if (!Util.formCheck()) {
                return;
    ...
    Period.prototype.create = function () {
        try {
    ...
    Period.prototype.delete = function (data) {
        var _this = this;
        try {
    ...
    Period.prototype.edit = function (data) {
        try {
    ...
    Period.prototype.search = function (keyword) {
        try {
