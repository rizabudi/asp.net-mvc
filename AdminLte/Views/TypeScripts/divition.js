var Divition = /** @class */ (function () {
    function Divition() {
        ...
        this.urlEdit = '/divition/edit';
        this.urlSearch = '/divition/search';
        this.currentPage = 1;
        this.init();
    }
    Divition.prototype.init = function () {
        var _this = this;
        try {
    ...
    Divition.prototype.initTable = function (page) {
        try {
    ...
    Divition.prototype.add = function () {
        try {
    ...
    Divition.prototype.initForm = function () {
        var _this = this;
        try {
    ...
    Divition.prototype.save = function () {
        var _this = this;
        try {
    ...
    Divition.prototype.create = function () {
        try {
            var data = {
                ID: $('#ID').val(),
                Name: $('#Name').val()
    ...
    Divition.prototype.delete = function (data) {
        var _this = this;
        try {
    ...
    Divition.prototype.edit = function (data) {
        try {
    ...
    Divition.prototype.search = function (keyword) {
        try {
...
//# sourceMappingURL=divition.js.map