var CompanyFunction = /** @class */ (function () {
    function CompanyFunction() {
        ...
        this.urlEdit = '/function/edit';
        this.urlSearch = '/function/search';
        this.currentPage = 1;
        this.init();
    }
    CompanyFunction.prototype.init = function () {
        var _this = this;
        try {
    ...
    CompanyFunction.prototype.initTable = function (page) {
        try {
    ...
    CompanyFunction.prototype.add = function () {
        try {
    ...
    CompanyFunction.prototype.initForm = function () {
        var _this = this;
        try {
    ...
    CompanyFunction.prototype.save = function () {
        var _this = this;
        try {
            if (!Util.formCheck()) {
                return;
    ...
    CompanyFunction.prototype.create = function () {
        try {
            var data = {
                ID: $('#ID').val(),
                Name: $('#Name').val()
    ...
    CompanyFunction.prototype.delete = function (data) {
        var _this = this;
        try {
    ...
    CompanyFunction.prototype.edit = function (data) {
        try {
    ...
    CompanyFunction.prototype.search = function (keyword) {
        try {
