var Assesment = /** @class */ (function () {
    ...
    Assesment.prototype.init = function () {
        var _this = this;
        try {
    ...
    Assesment.prototype.initTable = function (page) {
        try {
    ...
    Assesment.prototype.add = function () {
        try {
    ...
    Assesment.prototype.initForm = function () {
        var _this = this;
        try {
    ...
    Assesment.prototype.save = function () {
        var _this = this;
        try {
            if (!Util.formCheck()) {
                return;
    ...
    Assesment.prototype.create = function () {
        try {
            var data = {
                ID: $('#ID').val(),
                Name: $('#Name').val(),
    ...
    Assesment.prototype.delete = function (data) {
        var _this = this;
        try {
    ...
    Assesment.prototype.edit = function (data) {
        try {
...
//# sourceMappingURL=assesment.js.map