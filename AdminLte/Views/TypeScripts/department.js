var Department = /** @class */ (function () {
    ...
    Department.prototype.initTable = function (page) {
        try {
    ...
    Department.prototype.initForm = function () {
        var _this = this;
        try {
    ...
    Department.prototype.create = function () {
        try {
            var data = {
                ID: $('#ID').val(),
                Name: $('#Name').val()
    ...
    Department.prototype.delete = function (data) {
        var _this = this;
        try {
    ...
    Department.prototype.edit = function (data) {
        try {
