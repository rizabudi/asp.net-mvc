    ...
    public class ProfileController : Controller
    {
        ...
        public async Task<IActionResult> GetFormAsync()
        {
            try
            {
                ...
                FormModels.Add(new FormModel { Label = "Masa kerja di PT. Pertamina", Name = "WorkDuration", Note = "Tahun", InputType = InputType.NUMBER_POSITIVE, Value = participantUserFromDb == null || participantUserFromDb.WorkDuration == null ? "" : participantUserFromDb.WorkDuration.Value.ToString(), IsRequired = true });
